...
*Часть vlan`ов (50 и 60) будет использовать distributed gateway внутои фабрики, остальные будут маршрутизироваться через Firewall для фильтрации трафика*
...
*на boarder leaf'ах (leaf1-1, leaf1-2) добавим статический маршрут, чтобы трафик, не предназначеный для vfr DS (vlan 50, 60 и 70), уходил на Firewall* 
